...
exports.create = function(array) {
  var act, actionsArray, bodyText, button, buttonArray, card, cardFooter, i, icon, j, k, l, len, len1, len2, ref, setup, thumbnail, title;
  setup = m.utils.setupComponent(array, exports.defaults);
  card = new Layer({
    name: "Card",
    backgroundColor: m.color(setup.backgroundColor),
  ...
  if (setup.footer) {
    ...
    setup.footer.forEach(function(item) {
      var button;
      if (i === 0) {
        button = new m.Button({
          name: item,
